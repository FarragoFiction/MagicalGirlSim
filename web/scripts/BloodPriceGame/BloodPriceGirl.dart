...
class BloodPriceGirl extends MagicalGirlCharacterObject{
    ...
    Future<Null> totallyDiePure() async{
        ...
        clearDebts();
        game.healthBar.cutscene("Unfortunately, ${name} has succumbed to her injuries. $debts. The city will be doomed without a protector. The 🐥 must find someone new to take up the mantle of a Magical Girl.");
